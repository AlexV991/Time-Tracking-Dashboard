...
const Weekly = () => {
    ...
    return (
            ...
            <div className="fullCard">
                ...
                <div className="lowerWorkCard">
                    ...
                    <div className="bottomSideWorkCard">
                        <p className="p1">32hrs</p>
                        <p className="p2">Last Week - 36hrs</p>     </div>
                </div>
            </div>
            {/* //Game  */}
            <div className="fullCard">
                ...
                <div className="lowerWorkCard">
                    ...
                    <div className="bottomSideWorkCard">
                        <p className="p1">10hrs</p>
                        <p className="p2">Last Week - 8hrs</p>
                    </div>
                </div>
            </div>
        ...
        <div className = "bottomSideWorkCard">
            <p className ="p1">4hrs</p>
            <p className ="p2">Last Week - 7hrs</p>    
        </div>
        </div>  
        </div>
        ...
        <div className = "bottomSideWorkCard">
            <p className ="p1">4hrs</p>
            <p className ="p2">Last Week - 5hrs</p>    
        </div>
        </div>  
        </div>
        ...
        <div className = "bottomSideWorkCard">
            <p className ="p1">5hrs</p>
            <p className ="p2">Last Week - 10hrs</p>    
        </div>
        </div>  
        </div>
        ...
        <div className = "bottomSideWorkCard">
            <p className ="p1">2hrs</p>
            <p className ="p2">Last Week - 2hrs</p>    
        </div>
        </div>  
        </div>
            </>
