    ...
    return (
        ...
        {/* // Work */}
            <div className="fullCard">
                ...
                <div className="lowerWorkCard">
                    <div className="topSideWorkCard">
                        <div className="Work">
                            <p>Work</p>
                        </div>
                        <div className="dots">
                            <svg width="21" height="5" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z" fill="#BBC0FF" /></svg>
                        </div>
                    </div>
                    <div className="bottomSideWorkCard">
                        <p className="p1">103hrs</p>
                        <p className="p2">Last Month - 128hrs</p>     </div>
                </div>
            </div>
            {/* //Game  */}
            <div className="fullCard">
                <div id="headerGameCard">
                ...
                <div className="lowerWorkCard">
                    ...
                    <div className="bottomSideWorkCard">
                        <p className="p1">23hrs</p>
                        <p className="p2">Last Month - 29hrs</p>
                    </div>
                </div>
            </div>
        ...
        <div className = "bottomSideWorkCard">
            <p className ="p1">13hrs</p>
            <p className ="p2">Last Month - 19hrs</p>    
        </div>
        </div>  
        </div>
        ...
        <div className = "bottomSideWorkCard">
            <p className ="p1">11hrs</p>
            <p className ="p2">Last Month - 18hrs</p>    
        </div>
        </div>  
        </div>
        ...
        <div className = "bottomSideWorkCard">
            <p className ="p1">21hrs</p>
            <p className ="p2">Last Month - 23hrs</p>    
        </div>
        </div>  
        </div>
        ...
        <div className = "bottomSideWorkCard">
            <p className ="p1">7hrs</p>
            <p className ="p2">Last Month - 11hrs</p>    
        </div>
        </div>  
        </div>
