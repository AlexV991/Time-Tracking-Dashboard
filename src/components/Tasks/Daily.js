...
const Daily = () => {
    return (
            ...
            <div className="fullCard">
                ...
                <div className="lowerWorkCard">
                    ...
                    <div className="bottomSideWorkCard">
                        ...
                        <p className="p2">Previous Day - 7hrs</p>     </div>
                </div>
            </div>
            {/* //Game  */}
            <div className="fullCard">
                ...
                <div className="lowerWorkCard">
                    ...
                    <div className="bottomSideWorkCard">
                        <p className="p1">1hrs</p>
                        <p className="p2">Previous Day - 2hrs</p>
                    </div>
                </div>
            </div>
        ...
        <div className = "bottomSideWorkCard">
            <p className ="p1">0hrs</p>
            <p className ="p2">Previous Day - 1hrs</p>    
        </div>
        </div>  
        </div>
        ...
        <div className = "bottomSideWorkCard">
            <p className ="p1">1hrs</p>
            <p className ="p2">Previous Day - 3hrs</p>    
        </div>
        </div>  
        </div>
